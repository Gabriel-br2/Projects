...
def pause():                                                        
    L_P = [Rectangle(Point(0,0),Point(400,650)),Rectangle(Point(10,10),Point(390,640)),Text(Point(180,625),"Gabriel R. Souza - mat - v1.2"),Image(Point(200,110),"resource/pause/logo.png"),Image(Point(200,345),"resource/pause/start(0).png"),Image(Point(200,345),"resource/pause/start(1).png"),Image(Point(200,480),"resource/pause/exit(0).png"),Image(Point(200,480),"resource/pause/exit(1).png")]
...
def Menu_inicial():                                                
    ...
    LT = [Text(Point(210,625),"Gabriel R. Souza - mat - v1.2"),Text(Point(875,460),"Movimentação"),Text(Point(826,570),"Tiro"),Text(Point(832,290),"Pause"),Text(Point(635,395),"W"),Text(Point(565,465),"A"),Text(Point(635,465),"S"),Text(Point(705,465),"D"),Text(Point(635,570),"SPACE"),Text(Point(635,290),"ESC")]
...
def inicio():                                                      
    ...
    L_ini = [Text(Point(500,300),"FURG - C3"),Text(Point(500,325),"Algoritmos para Engenharia de Automação"),Text(Point(500,350),"Prof. Marcelo Malheiros"),Text(Point(500,300),"PRIMEIRO PROJETO"),Text(Point(500,325),"Gabriel R. Souza"),Text(Point(500,350),"Matrícula - mat")]
    R.setFill("black")
    for a in range(6):
