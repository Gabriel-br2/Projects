...
def main():
    ...
    but = [(727, 105, 60, 60),(30,313,50,30),(85, 313, 100, 30),(190,313,100,30),(295,313,100,30),(400,313,30,30),(435,313,30,30),(470,313,30,30),(622,313,100,30),(727,313,28,30),(760,313,28,30),(505,313,80,30),(590,313,27,30)]
    ...
    rects_sc = genRectmatrix(728,178,tamXC,tamYC,17,4.5,False) 
    ...
    while running: 
        ...
        for event in pygame.event.get():
            ...
            if test and (not anim) and Tool == 1:
                ...
                else: main_matrix[current_frame][changed_Y][changed_X] = (r, g, b)
            ...
            if status[1] and et_mouse and (not anim):
                c,option = SelectOP_anim(30,343,screen,font, ["New","Export","Export as","Load"])
            ...
            if status[11] and et_mouse and (not anim):
                if Tool != 0:
                    ...
                    c,Tool = SelectOP_anim(505,343,screen,font,["Color Dtc","Line","Square","Circle"])
                    Point = []
        ...
        if anim:
            pygame.draw.rect(screen,(150,150,150),(480,322,4,14))
            pygame.draw.rect(screen,(150,150,150),(486.5,322,4,14))
        else: pygame.draw.polygon(screen,(150,150,150),[[480, 323],[490,328],[480,333]])
        if full: pygame.draw.rect(screen,(150,150,150),(595,318,17,20),0) 
        else: pygame.draw.rect(screen,(150,150,150),(595,318,17,20),2)
        if removC: pygame.draw.circle(screen, (255, 0, 0),[622, 313], 5) 
        
        if Tool == 2 or Tool == 3 or Tool == 4:
            if len(Point) == 1: pygame.draw.rect(screen,(150,150,150),(508,338,35,2))
            elif len(Point) == 2: pygame.draw.rect(screen,(150,150,150),(545,338,35,2))
